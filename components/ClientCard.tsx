        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "10px" }}>
          <div style={{ flex: 1, minWidth: 0, paddingRight: "10px" }}>
            <div style={{
              ...
              color: "rgba(74,222,128,0.55)", fontFamily: "'Inter', sans-serif", fontWeight: 600, marginBottom: "4px",
            }}>
              Sub-Client
            </div>
            <h3 style={{
              fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700,
              fontSize: "16px", color: "#f0f7f0", lineHeight: 1.25, wordBreak: "break-word", margin: 0,
            }}>
              {name}
            </h3>
          </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "14px" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "5px" }}>
            <span style={{
              ...
              fontSize: "42px", color: clr, lineHeight: 1, letterSpacing: "-0.02em",
            }}>
              {averageScore}
            </span>
